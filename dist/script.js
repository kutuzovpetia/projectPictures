...
window.addEventListener('DOMContentLoaded', function () {
  ...
  Object(_modules_slider__WEBPACK_IMPORTED_MODULE_1__["default"])('.main-slider-item', 'vertica');
});
...
var modals = function modals() {
  ...
  function bindModal(triggerSelector, modalSelector, closeSelector) {
    ...
    var close = document.querySelectorAll(closeSelector); // const modalAll = document.querySelectorAll('[data-modal]');
    ...
    modal.addEventListener('click', function (e) {
      if (e.target === modal) {
        modal.style.display = 'none';
        document.body.style.overflow = '';
        document.body.style.marginRight = '0px'; // document.body.classList.remove('')
      }
    });
  }
  ...
  openByScroll('.fixed-gift'); // showModalByTime('.popup-consultation', 2000);
};
